...
class T2T_module(nn.Module):
    ...
    """
    def __init__(self, img_size_W=1280, img_size_H=384, tokens_type='performer', in_chans=3, embed_dim=768, token_dim=64):
        super().__init__()
        ...
        self.num_patches = (img_size_W // (4 * 2 * 2)) * (img_size_H // (4 * 2 * 2))  # there are 3 sfot split, stride are 4,2,2 seperately
...
class T2T_ViT(nn.Module):
    def __init__(self, img_size_W=1280, img_size_H=384, tokens_type='performer', in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.tokens_to_token = T2T_module(
                img_size_W=img_size_W, img_size_H=img_size_H, tokens_type=tokens_type, in_chans=in_chans, embed_dim=embed_dim)
